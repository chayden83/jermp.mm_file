...
if(NOT VAULT_PTHASH_MM_FILE_CONFIG_FILE_PACKAGE)
    return()
endif()
...
configure_package_config_file(
    ...
    INSTALL_DESTINATION "${VAULT_PTHASH_MM_FILE_INSTALL_CMAKEDIR}"
...
write_basic_package_version_file(
    ...
    COMPATIBILITY
        ${VAULT_PTHASH_MM_FILE_CONFIG_FILE_PACKAGE_COMPATIBILITY}
)
...
install(
    FILES
        "${PROJECT_BINARY_DIR}/cmake/${PROJECT_NAME}-config.cmake"
        "${PROJECT_BINARY_DIR}/cmake/${PROJECT_NAME}-version.cmake"
    DESTINATION "${VAULT_PTHASH_MM_FILE_INSTALL_CMAKEDIR}"
    COMPONENT
        ${VAULT_PTHASH_MM_FILE_CONFIG_FILE_PACKAGE_INSTALL_COMPONENT}
)
